...
render_why_board() {
  ...
  filter+=",drawtext=fontfile='$subtitle_font':text='AI is new for everyone. This is your big advantage.':fontsize=28:fontcolor=0x655f7c:x=(w-text_w)/2:y=102"
  ...
  filter+=",drawtext=fontfile='$title_font':text='THIS IS YOUR TIME':fontsize=32:fontcolor=0x08072b:x=80+(480-text_w)/2:y=286"
  filter+=",drawtext=fontfile='$title_font':text='YOU’LL MOVE FASTER':fontsize=32:fontcolor=0x08072b:x=560+(480-text_w)/2:y=286"
  filter+=",drawtext=fontfile='$title_font':text='NOTHING TO UNLEARN':fontsize=32:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=286"
...
render_llm_board() {
  ...
  filter+=",drawtext=fontfile='$title_font':text='Large':fontsize=32:fontcolor=0x3b82f6:x=80+(480-text_w)/2:y=282"
  filter+=",drawtext=fontfile='$title_font':text='Language':fontsize=32:fontcolor=0x10b981:x=560+(480-text_w)/2:y=282"
  filter+=",drawtext=fontfile='$title_font':text='Model':fontsize=32:fontcolor=0xf59e0b:x=1040+(480-text_w)/2:y=282"
...
render_school_board() {
  ...
  filter+=";[2:v][panel]overlay=80:172[s1]"
  filter+=";[s1][badge1]overlay=288:206[s2];[s2][badge2]overlay=768:206[s3];[s3][badge3]overlay=1248:206[s4]"
  filter+=";[s4][art1]overlay=125:590[s5];[s5][art2]overlay=605:590[s6];[s6][art3]overlay=1085:590[s7]"
  filter+=";[s7]drawbox=x=560:y=204:w=2:h=624:color=0xe4e0f3:t=fill,drawbox=x=1040:y=204:w=2:h=624:color=0xe4e0f3:t=fill"
  filter+=",drawbox=x=120:y=568:w=400:h=2:color=0xc9c3e8:t=fill,drawbox=x=600:y=568:w=400:h=2:color=0xc9c3e8:t=fill,drawbox=x=1080:y=568:w=400:h=2:color=0xc9c3e8:t=fill"
  filter+=",drawtext=fontfile='$arrow_font':text='→':fontsize=64:fontcolor=0x6546d7:x=526:y=626,drawtext=fontfile='$arrow_font':text='→':fontsize=64:fontcolor=0x0b66dc:x=1006:y=626"
  ...
  filter+=",drawtext=fontfile='$title_font':text='ASK THE RIGHT':fontsize=32:fontcolor=0x08072b:x=80+(480-text_w)/2:y=278"
  filter+=",drawtext=fontfile='$title_font':text='QUESTION':fontsize=32:fontcolor=0x08072b:x=80+(480-text_w)/2:y=316"
  filter+=",drawtext=fontfile='$title_font':text='AI ANSWER':fontsize=32:fontcolor=0x08072b:x=560+(480-text_w)/2:y=297"
  filter+=",drawtext=fontfile='$title_font':text='MAKE THE ANSWER':fontsize=32:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=278"
  filter+=",drawtext=fontfile='$title_font':text='BETTER':fontsize=32:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=316"
  filter+=",drawtext=fontfile='$subtitle_font':text='What you know shapes':fontsize=30:fontcolor=0x08072b:x=80+(480-text_w)/2:y=354"
  filter+=",drawtext=fontfile='$subtitle_font':text='what you ask.':fontsize=30:fontcolor=0x08072b:x=80+(480-text_w)/2:y=392"
  filter+=",drawtext=fontfile='$subtitle_font':text='A sharper question gets':fontsize=30:fontcolor=0x08072b:x=80+(480-text_w)/2:y=430"
  filter+=",drawtext=fontfile='$subtitle_font':text='a better answer before':fontsize=30:fontcolor=0x08072b:x=80+(480-text_w)/2:y=468"
  filter+=",drawtext=fontfile='$subtitle_font':text='AI does anything special.':fontsize=30:fontcolor=0x08072b:x=80+(480-text_w)/2:y=506"
  filter+=",drawtext=fontfile='$subtitle_font':text='Similar questions get':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=354"
  filter+=",drawtext=fontfile='$subtitle_font':text='similar answers.':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=392"
  filter+=",drawtext=fontfile='$subtitle_font':text='The answer is a starting':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=430"
  filter+=",drawtext=fontfile='$subtitle_font':text='point, not the finish.':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=468"
