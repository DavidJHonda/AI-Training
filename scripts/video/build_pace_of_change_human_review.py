...
TABLE = Section(
    ...
    (
        ...
        Phase((Span(17.260, 25.960),), (70, 220, 1534, 384), base.PURPLE,
              (40, 185, 1560, 390)),
        Phase((Span(25.960, 37.640),), (70, 402, 1534, 560), base.PURPLE,
              (40, 385, 1560, 570)),
        Phase((Span(37.640, 54.260),), (70, 575, 1534, 784), base.PURPLE,
              (40, 560, 1560, 795)),
        Phase((Span(54.260, 69.720),), (70, 796, 1534, 934), base.PURPLE,
              (40, 775, 1560, 950)),
...
ACCELERANTS = Section(
    ...
    (
        ...
        Phase((Span(95.300, 102.000),), (40, 124, 527, 734), base.PURPLE,
              (40, 124, 527, 734)),
        Phase((Span(102.000, 113.060),), (558, 124, 1043, 734), base.BLUE,
              (558, 124, 1043, 734)),
        Phase((Span(113.060, 125.000),), (1074, 124, 1561, 734), base.TEAL,
              (1074, 124, 1561, 734)),
        Phase((Span(125.000, 137.440),), (1074, 124, 1561, 734), base.TEAL,
              (1074, 124, 1561, 734)),
    ),
)
...
RESEARCH = Section(
    ...
    (
        ...
        Phase((Span(159.800, 173.100),), (40, 124, 785, 762), base.TEAL,
              (40, 124, 785, 762)),
        Phase((Span(173.100, 188.800),), (815, 124, 1561, 762), base.PURPLE,
              (815, 124, 1561, 762)),
...
CAPABILITY = Section(
    ...
    (
        ...
        Phase((Span(214.000, 234.040),), (40, 124, 785, 762), base.BLUE,
              (40, 124, 785, 762)),
        Phase((Span(234.040, 249.960),), (815, 124, 1561, 762), base.RED,
              (815, 124, 1561, 762)),
