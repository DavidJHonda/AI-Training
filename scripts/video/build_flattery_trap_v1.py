#!/usr/bin/env python3
"""Build Flattery Trap v1 from flattery-trap-4 (2026-09-21 five-way review: rolls 1-4 and the live video).
...
OUT = ROOT / "video-audit/flattery-trap-comparison-2026-09-21/build-v1"
DEST = ROOT / "Prompts/flattery-trap-v1.mp4"
...
G_IN, G_OUT = 4546, 4643           # roll 2, 2:31.53-2:34.77 ("But while the problem has improved…")
...
def main():
    ...
    b.manifest({
        ...
        "picture_advance": {
            "rows": "the three rows from 2:23.90 to 2:45.67",
            "detail": ("roll 4 holds Notebook's Sycophancy render to its own cut at frame 4333 while the next "
