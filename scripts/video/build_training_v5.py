#!/usr/bin/env python3
"""Training v5 review candidate from training-1 (2026-09-22 roll). Review only.
...
donor pair). Roll 1 is the narration (8 of 8 verbatim lines). Five of its own sentences are cut at sentence silences
...
OUT = ROOT / "video-audit/training-comparison-2026-09-22/build-v5"
DEST = ROOT / "Prompts/training-v5.mp4"
...
def main():
    ...
    b.keep(B_IN, BEFORE_IN, "The Training Loop: the loop runs again, banner", "loop")
    ...
    ], banner_at=66.34, banner=LOOP_BANNER, push=False)
