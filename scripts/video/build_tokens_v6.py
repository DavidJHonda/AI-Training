...
def main():
 ...
 assets={'chat':ROOT/'course-assets/tokens/tokens-using-ai-feels-like-editorial.jpg','blocks':ROOT/'course-assets/tokens/tokens-building-blocks-editorial.jpg','send':ROOT/'course-assets/tokens/tokens-how-tokenization-works-editorial.jpg','cat':ROOT/'course-assets/tokens/tokens-cat-token-id-editorial.jpg','examples':ROOT/'course-assets/tokens/tokens-how-ai-splits-text-verified-editorial.jpg','whole':OUT/'assets/whole-and-part.png','math':OUT/'assets/words-to-math.png','close':OUT/'close.png'}
