...
render_strength() {
  ...
  filter+=",drawtext=fontfile='$title_font':text='WHAT IT DOES':fontsize=20:fontcolor=0x${accent}:x=770:y=214"
  filter+=",drawtext=fontfile='$subtitle_font':text='$mechanism_1':fontsize=27:fontcolor=0x08072b:x=770:y=254"
  filter+=",drawtext=fontfile='$subtitle_font':text='$mechanism_2':fontsize=27:fontcolor=0x08072b:x=770:y=290"
  filter+=",drawtext=fontfile='$subtitle_font':text='$mechanism_3':fontsize=27:fontcolor=0x08072b:x=770:y=326"
  if [[ -n "$mechanism_4" ]]; then
    filter+=",drawtext=fontfile='$subtitle_font':text='$mechanism_4':fontsize=27:fontcolor=0x08072b:x=770:y=362"
  fi
  filter+=",drawbox=x=770:y=412:w=680:h=2:color=0xe4e0f3:t=fill"
  filter+=",drawtext=fontfile='$title_font':text='EXAMPLES':fontsize=20:fontcolor=0x${accent}:x=770:y=440"
  filter+=",drawtext=fontfile='$title_font':text='•':fontsize=26:fontcolor=0x${accent}:x=770:y=482"
  filter+=",drawtext=fontfile='$subtitle_font':text='$example_1':fontsize=25:fontcolor=0x08072b:x=804:y=482"
  filter+=",drawtext=fontfile='$title_font':text='•':fontsize=26:fontcolor=0x${accent}:x=770:y=527"
  filter+=",drawtext=fontfile='$subtitle_font':text='$example_2':fontsize=25:fontcolor=0x08072b:x=804:y=527"
  filter+=",drawtext=fontfile='$title_font':text='•':fontsize=26:fontcolor=0x${accent}:x=770:y=572"
  filter+=",drawtext=fontfile='$subtitle_font':text='$example_3':fontsize=25:fontcolor=0x08072b:x=804:y=572"
  filter+=",drawtext=fontfile='$title_font':text='•':fontsize=26:fontcolor=0x${accent}:x=770:y=617"
  filter+=",drawtext=fontfile='$subtitle_font':text='$example_4':fontsize=25:fontcolor=0x08072b:x=804:y=617"
