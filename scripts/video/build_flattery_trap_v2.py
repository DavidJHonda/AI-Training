#!/usr/bin/env python3
"""Build Flattery Trap v2 from flattery-trap-4 (2026-09-21 five-way review: rolls 1-4 and the live video).
...
OUT = ROOT / "video-audit/flattery-trap-comparison-2026-09-21/build-v2"
DEST = ROOT / "Prompts/flattery-trap-v2.mp4"
