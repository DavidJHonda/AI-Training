...
filter+=",drawtext=fontfile='$title_font':text='Scams that scale':fontsize=32:fontcolor=0x1970cf:x=80+(480-text_w)/2:y=288"
filter+=",drawtext=fontfile='$title_font':text='Deepfakes of real people':fontsize=32:fontcolor=0x7145d3:x=560+(480-text_w)/2:y=288"
filter+=",drawtext=fontfile='$title_font':text='Confident but wrong':fontsize=32:fontcolor=0x138c82:x=1040+(480-text_w)/2:y=288"
