...
render_school_board() {
  ...
  filter+=",drawtext=fontfile='$title_font':text='Same AI. Different value.':fontsize=44:fontcolor=0x08072b:x=(w-text_w)/2:y=40+(100-text_h)/2-2"
  filter+=",drawtext=fontfile='$card_title_font':text='ASK THE RIGHT':fontsize=32:fontcolor=0x152b7a:x=80+(480-text_w)/2:y=278"
  filter+=",drawtext=fontfile='$card_title_font':text='QUESTION':fontsize=32:fontcolor=0x152b7a:x=80+(480-text_w)/2:y=316"
  filter+=",drawtext=fontfile='$card_title_font':text='AI ANSWER':fontsize=32:fontcolor=0x152b7a:x=560+(480-text_w)/2:y=297"
  filter+=",drawtext=fontfile='$card_title_font':text='MAKE THE ANSWER':fontsize=32:fontcolor=0x152b7a:x=1040+(480-text_w)/2:y=278"
  filter+=",drawtext=fontfile='$card_title_font':text='BETTER':fontsize=32:fontcolor=0x152b7a:x=1040+(480-text_w)/2:y=316"
