...
ROOT=Path(__file__).resolve().parents[2];OUT=ROOT/'video-audit/transformer-full-2026-09-10';DEST=ROOT/'Prompts/transformer-v3.mp4';ASSETS=ROOT/'video-audit/transformer-repair-2026-09-10'
...
def main():
 ...
 protected=[*sources.values(),ROOT/'Prompts/transformer-v2.mp4',ROOT/'course-assets/transformer/transformer.mp4',ROOT/'index.html',ROOT/'lessons/transformer.md']
 ...
 keep(1,108.78,120.1,'Whole message and direct CAT-to-IT connection','reads')
 keep(1,121.0333333333,124.7666666667,'Draws information from CAT; instantly removed','reads')
