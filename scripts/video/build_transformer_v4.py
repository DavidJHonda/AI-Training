...
ROOT=Path(__file__).resolve().parents[2];OUT=ROOT/'video-audit/transformer-full-2026-09-10/v4';DEST=ROOT/'Prompts/transformer-v4.mp4';ASSETS=ROOT/'video-audit/transformer-repair-2026-09-10'
...
def main():
 ...
 protected=[*sources.values(),ROOT/'Prompts/transformer-v2.mp4',ROOT/'Prompts/transformer-v3.mp4',ROOT/'course-assets/transformer/transformer.mp4',ROOT/'index.html',ROOT/'lessons/transformer.md']
