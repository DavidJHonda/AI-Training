#!/usr/bin/env python3
"""Data Centers v3 review candidate from data-centers-3 (2026-09-24). Review only.
...
OUT = ROOT / "video-audit/data-centers-v3-2026-09-24/build"
DEST = P / "data-centers-v3.mp4"
...
# Canonical boards, measured 2026-09-24 (separate rounded white cards on the lavender stage; tile top to last white row).
