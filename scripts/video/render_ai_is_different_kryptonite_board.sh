...
filter+=";[s4][art1]overlay=320-overlay_w/2:466[s5]"
filter+=";[s5][art2]overlay=800-overlay_w/2:466[s6]"
filter+=";[s6][art3]overlay=1280-overlay_w/2:466[s7]"
...
filter+=",drawbox=x=120:y=442:w=400:h=2:color=0xc9c3e8:t=fill"
filter+=",drawbox=x=600:y=442:w=400:h=2:color=0xc9c3e8:t=fill"
filter+=",drawbox=x=1080:y=442:w=400:h=2:color=0xc9c3e8:t=fill"
...
filter+=",drawtext=fontfile='$title_font':text='Scams that scale':fontsize=28:fontcolor=0x1970cf:x=80+(480-text_w)/2:y=292"
filter+=",drawtext=fontfile='$title_font':text='Deepfakes of real people':fontsize=28:fontcolor=0x7145d3:x=560+(480-text_w)/2:y=292"
filter+=",drawtext=fontfile='$title_font':text='Confident but wrong':fontsize=28:fontcolor=0x138c82:x=1040+(480-text_w)/2:y=292"
filter+=",drawtext=fontfile='$body_font':text='AI generates code, convincing':fontsize=24:fontcolor=0x08072b:x=80+(480-text_w)/2:y=344"
filter+=",drawtext=fontfile='$body_font':text='messages, and fake identities':fontsize=24:fontcolor=0x08072b:x=80+(480-text_w)/2:y=376"
filter+=",drawtext=fontfile='$body_font':text='in seconds.':fontsize=24:fontcolor=0x08072b:x=80+(480-text_w)/2:y=408"
filter+=",drawtext=fontfile='$body_font':text='Convincing fakes can target and':fontsize=24:fontcolor=0x08072b:x=560+(480-text_w)/2:y=344"
filter+=",drawtext=fontfile='$body_font':text='humiliate anyone, including':fontsize=24:fontcolor=0x08072b:x=560+(480-text_w)/2:y=376"
filter+=",drawtext=fontfile='$body_font':text='students.':fontsize=24:fontcolor=0x08072b:x=560+(480-text_w)/2:y=408"
filter+=",drawtext=fontfile='$body_font':text='Medical or safety answers can':fontsize=24:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=344"
filter+=",drawtext=fontfile='$body_font':text='sound fluent and sure even when':fontsize=24:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=376"
filter+=",drawtext=fontfile='$body_font':text='they are flat wrong.':fontsize=24:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=408"
