...
BOARDS = (
    Board(
        ...
        page_output="course-assets/people-skills/people-skills-why-people-matter.jpg",
        prep_output="course-assets/people-skills/people-skills-why-people-matter.jpg",
    ...
    Board(
        ...
        page_output="course-assets/creative-thinking/creative-thinking-creative-professions.jpg",
        prep_output="course-assets/creative-thinking/creative-thinking-creative-professions.jpg",
    ...
    Board(
        ...
        page_output="course-assets/creative-thinking/creative-thinking-practice-creativity.jpg",
        prep_output="course-assets/creative-thinking/creative-thinking-practice-creativity.jpg",
        accents=(PURPLE, BLUE, TEAL, AMBER),
    ),
    Board(
        ...
        page_output="course-assets/curious-and-flexible/curious-and-flexible-stay-curious.jpg",
        prep_output="course-assets/curious-and-flexible/curious-and-flexible-stay-curious.jpg",
        accents=(PURPLE, BLUE, TEAL, AMBER),
    ),
    Board(
        ...
        page_output="course-assets/curious-and-flexible/curious-and-flexible-be-flexible.jpg",
        prep_output="course-assets/curious-and-flexible/curious-and-flexible-be-flexible.jpg",
        accents=(PURPLE, BLUE, TEAL, AMBER),
    ),
    Board(
        ...
        page_output="course-assets/make-your-move/make-your-move-skills.jpg",
    ...
    Board(
        ...
        page_output="course-assets/make-your-move/make-your-move-actions.jpg",
