...
def replacements():
    ...
    add('praise-loop',ROOT/'course-assets/flattery-trap/flattery-trap-cycle-of-praise.jpg',
    ...
    add('sycophancy',ROOT/'course-assets/flattery-trap/flattery-trap-sycophancy.jpg',
        (162.066667,167.7,176.8,183.3),(
        ('establish',None,VP,None,0),
        ('brilliant-and-performance-art',(40,218,1560,402),P,None,0),
        ('viral-gold',(40,408,1560,615),P,None,0)))
    add('five-moves',ROOT/'course-assets/flattery-trap/flattery-trap-five-moves.jpg',
    ...
    add('standing-instruction',ROOT/'course-assets/flattery-trap/flattery-trap-five-moves.jpg',
...
def main():
    ...
    live=ROOT/'course-assets/flattery-trap/flattery-trap.mp4'
    ...
    with tempfile.TemporaryDirectory(prefix='flattery-trap-review-',dir='/private/tmp') as directory:
        ...
        close_image=cv2.imread(str(ROOT/'course-assets/flattery-trap/flattery-trap-close.jpg'))
