...
TABLE = Section(
    ...
    (
        Phase((Span(8.720, 13.000), Span(13.900, 17.260)), (38, 27, 700, 102), PURPLE),
...
ACCELERANTS = Section(
    ...
    (
        ...
        Phase((Span(102.000, 112.480),), (558, 124, 1043, 734), BLUE, (558, 124, 1043, 734)),
        Phase((Span(113.060, 124.020),), (1074, 124, 1561, 734), TEAL,
              (1074, 124, 1561, 734)),
...
RESEARCH = Section(
    ...
    (
        Phase((Span(159.020, 161.780),), (38, 28, 675, 104), PURPLE),
        Phase((Span(161.780, 173.100),), (40, 124, 785, 762), TEAL, (40, 124, 785, 762)),
        Phase((Span(173.100, 188.800),), (815, 124, 1561, 762), PURPLE,
              (815, 124, 1561, 762)),
        Phase((Span(188.800, 197.600),), (40, 798, 1561, 892), PURPLE),
    ),
)
...
CAPABILITY = Section(
    ...
    (
        Phase((Span(213.500, 234.040),), (40, 124, 785, 762), BLUE, (40, 124, 785, 762)),
        Phase((Span(234.040, 249.960),), (815, 124, 1561, 762), RED,
              (815, 124, 1561, 762)),
        Phase((Span(249.960, 253.700), Span(256.300, 260.040)), (40, 798, 1561, 892), PURPLE),
    ),
)
