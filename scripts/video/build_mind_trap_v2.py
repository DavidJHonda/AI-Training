#!/usr/bin/env python3
"""Build Mind Trap v2 from mind-trap-6 (2026-09-21 seven-way review: rolls 1-6 and the live video).
...
OUT = ROOT / "video-audit/mind-trap-comparison-2026-09-21/build-v2"
DEST = ROOT / "Prompts/mind-trap-v2.mp4"
...
TAIL_IN, TAIL_OUT = 5008, 5019   # v2: the rest of roll 6's post-takeaway pause, under roll 5's picture; cut 0.12 s before "Taking a chatbot's advice" (167.418)
