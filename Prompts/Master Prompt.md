...
- **LIGHT CANVAS (CRITICAL):** The light grid-paper canvas is the background of every frame of every video, from the opening frame onward. Dark colors belong only to individual UI pills and cards sitting on the paper. A dark, charcoal, or dark-mode full-frame background is strictly forbidden: if a frame's overall look is dark, it is wrong. The balance of every frame is mostly light paper and analog sketches, with dark digital elements as sparse accents.
