...
- **The engine can insert its own mid-video chapter cards** (welcome intake, 2026-07-07): an ~8s off-prompt segment — invented neural-net diagram b-roll, then a dark "Lesson 1: Architecture" title card — appeared at ~1:00, right where narration promises "the real machinery," despite NO TITLE CARD and ONLY THE SCENES LISTED. Ban it by name: rule 3 now lists "chapter-title" among forbidden extra scenes, and rule 1 in welcome bans mid-video chapter/lesson-number cards explicitly. Watch for it at topic-shift moments in narration.
