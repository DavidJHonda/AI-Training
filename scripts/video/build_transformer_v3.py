...
ROOT=Path(__file__).resolve().parents[2];OUT=ROOT/'video-audit/transformer-full-2026-09-10';DEST=ROOT/'videos/transformer-v3.mp4';ASSETS=ROOT/'video-audit/transformer-repair-2026-09-10'
...
def main():
 ...
 protected=[*sources.values(),ROOT/'videos/transformer-v2.mp4',ROOT/'videos/transformer.mp4',ROOT/'index.html',ROOT/'lessons/transformer.md']
