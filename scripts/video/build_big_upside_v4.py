#!/usr/bin/env python3
"""Big Upside v4 review candidate from big-upside-6 (2026-09-24). Review only.
...
OUT = ROOT / "video-audit/big-upside-v4-2026-09-24/build"
DEST = P / "big-upside-v4.mp4"
...
def main():
    ...
    b.keep(8620, 8943, "PHOTOS COVERED (Hassabis portrait, young man): R3 STRATEGIC PLAY chess and simulation cards",
           video_from=5712, video_src=R3, video_end=5935)
    ...
    b.keep(9178, 9292, "PHOTO COVERED (Nobel medal): R4 timeline cards with the drawn Nobel medal", video_from=5100, video_src=R4b, video_end=5216)
    b.mark_close_start()
    ...
    b.manifest({
        "scope_detail": "Full production pass on big-upside-6 (David's 'yes' 2026-09-24 on the review's repair plan): six narration cuts, one audio graft from roll 3, canonical boards, the timeline broken once, the closing photographs and drawn people covered with rolls 3 and 4 drawings, standard close.",
        "narration_changes": {
        ...
        "photographs_and_people_covered": [
            ...
            {"source_frames": [8620, 8784], "what": "Hassabis portrait photograph", "cover": "R3 5712-5934 STRATEGIC PLAY cards"},
            ...
            {"source_frames": [9178, 9292], "what": "Nobel medal photograph", "cover": "R4 5100-5215 drawn Nobel medal card"},
