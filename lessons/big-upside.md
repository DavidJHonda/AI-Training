...
A protein is a long string of chemical beads that folds into one shape. Possible shapes: a medium protein can fold more ways than there are atoms in the universe. Function: a protein’s shape affects what it does, some diseases involve proteins folding or behaving incorrectly, and many drugs work by binding to proteins and changing what they do.
...
Demis Hassabis was a chess master at 13 and co-designed a hit video game at 17. He founded DeepMind, and in 2020 DeepMind’s AlphaFold solved the protein-folding prediction problem. For many proteins, AlphaFold predicted shapes with accuracy close to lab methods.
