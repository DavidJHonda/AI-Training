...
OUT = ROOT / "video-audit/avoid-traps-opener-comparison-2026-09-21/build-v5"
DEST = ROOT / "Prompts/avoid-traps-opener-v5.mp4"
...
def main():
    ...
    line = lambda y0, y1: [100, y0, 820, y1]
    b.board("traps", TRAPS, 0, TRAPS_OUT, "compact", [
        target("The false fact sounds sure.", 0.0, line(350, 407), NEUTRAL),
        target("The flattery feels good.", 2.90, line(422, 488), NEUTRAL),
        target("The fake looks real.", 4.82, line(496, 553), NEUTRAL),
        target("every trap looks fine from the inside.", 9.64, line(564, 622), NEUTRAL),
