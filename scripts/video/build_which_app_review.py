#!/usr/bin/env python3
"""Which App? (lesson id modelselection) from roll 1 under EDIT-SPEC.md, best-of grafts from roll 2 (2026-09-15). Review only.
...
Output: videos/which-app-v1.mp4. Audit: video-audit/which-app-repair-2026-09-15/.
...
OUT = ROOT / 'video-audit/which-app-repair-2026-09-15'; DEST = ROOT / 'videos/which-app-v1.mp4'
...
def main():
    ...
    b = Build(ROOT, SRC, OUT, DEST, protected=[ROOT / 'videos/which-app.mp4', SRC2, *B.values()])
