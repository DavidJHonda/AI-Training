...
filter+=",drawtext=fontfile='$body_font':text='Convincing fakes can target':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=338"
filter+=",drawtext=fontfile='$body_font':text='and humiliate anyone,':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=376"
filter+=",drawtext=fontfile='$body_font':text='including students.':fontsize=30:fontcolor=0x08072b:x=560+(480-text_w)/2:y=414"
filter+=",drawtext=fontfile='$body_font':text='Medical and safety answers':fontsize=30:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=338"
filter+=",drawtext=fontfile='$body_font':text='can sound correct even when':fontsize=30:fontcolor=0x08072b:x=1040+(480-text_w)/2:y=376"
