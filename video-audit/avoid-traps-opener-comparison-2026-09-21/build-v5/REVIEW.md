# Avoid Traps opener v5 — build review (2026-09-21)
...
- Candidate: `Prompts/avoid-traps-opener-v5.mp4`
- SHA-256: `999383c68837fadf584d611e88faaaf9dba56aaa5258ea3ffd72cd53cd8a4adc`
- Runtime: 6,543 frames at 30 fps (3:38.10), 1280×720
- Build: `scripts/video/build_avoid_traps_opener_v5.py`; manifest `edit-manifest.json`
...
|---|---|---|
| The Traps Ahead | 0:00–0:13.10 | Canonical board replaces Notebook's render. Compact, still. Line rings at spoken onsets: "The false fact" 0:00 (pops in the full view, spec rule 3), "The flattery" 0:02.9, "The fake" 0:04.8, "every trap looks fine" 0:09.6. |
