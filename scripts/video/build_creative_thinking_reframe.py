...
LIVE = ROOT / 'course-assets/creative-thinking/creative-thinking.mp4'; DEST = ROOT / 'Prompts/creative-thinking-v4.mp4'
PY = ROOT / '.video-venv/bin/python'; KB = ROOT / 'scripts/video/ken_burns_path.py'; FF = imageio_ffmpeg.get_ffmpeg_exe()
ASSETS = {'1-professions': ROOT / 'course-assets/creative-thinking/creative-thinking-creative-professions.jpg', '2-practice': ROOT / 'course-assets/creative-thinking/creative-thinking-practice-creativity.jpg'}
