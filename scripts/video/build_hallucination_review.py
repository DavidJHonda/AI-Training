...
def replacements(card):
    ...
    add('real-text', 'course-assets/hallucination/hallucination-example.jpg',
...
def main():
    ...
    board = ROOT / 'course-assets/hallucination/hallucination-check-claim.jpg'
    assert common.file_md5(board) == common.file_md5(ROOT/'course-assets/hallucination/hallucination-check-claim.jpg')
    ...
    with tempfile.TemporaryDirectory(prefix='hallucination-review-', dir='/private/tmp') as folder:
        ...
        close_image = cv2.imread(str(ROOT/'course-assets/hallucination/hallucination-close.jpg'))
