...
**Image file:** `context-window-same-question-faceless.jpg`

![Same Question. Different Answers.](context-window-same-question-faceless.jpg)
...
That’s the big idea of this lesson: with the right context, AI gives better answers. The rest of this lesson is about where that context comes from, and how to take control of it.
...
**Image file:** `context-window-five-sources-faceless.jpg`

![The Context Window](context-window-five-sources-faceless.jpg)

**Teaching content:**

Five sources feed the context window. From this chat: your current prompt, plus earlier messages and answers. Personalization and memory: Personalization, and Saved Memory. Project context: Projects. The context window is the information available for this answer.
