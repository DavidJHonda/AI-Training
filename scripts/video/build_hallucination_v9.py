...
OUT = ROOT / "video-audit/hallucination-comparison-2026-09-21/build-v9"
DEST = ROOT / "Prompts/hallucination-v9.mp4"
...
TRUTH_HOLD = 5541                  # last TRUTH/FALSEHOOD frame, held over the stat drawing
...
def main():
    ...
    card = lambda i: [cols[i][0], 150, cols[i][1], 860]
    ...
    card4 = lambda i: [c4[i][0], 140, c4[i][1], 750]
