...
def main():
 ...
 ev(0,'native','original-notebook-opening');ev(11.733333,'native','notebook-expert');ev(19.966667,'confused','notebook-confusion');ev(25.566667,'native','expert-error-comparison');ev(34.2,'explain','underlying-machinery');ev(39.2,'native','notebook-driving');ev(61.4,'hood','under-the-hood-full-view',[40,1180,1560,1270],'#6e51ff');ev(68.066667,'native','notebook-reassurance');ev(82.766667,'map','map-establish')
