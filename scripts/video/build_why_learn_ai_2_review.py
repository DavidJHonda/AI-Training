...
def main():
    ...
    b.keep(2649, 2796, 'Live video: Layout Ready Macintosh drawing (replaces the vintage computer photo)', video_from=4854, video_src=DRAWINGS, video_end=5060)
    ...
    b.keep(4707, 5092, 'Live video: gear, bolt, globe drawing (replaces the engine and old computer photos)', video_from=5520, video_src=DRAWINGS, video_end=5856)   # starts as the gear draws in; the last frame holds 1.6s
    b.keep(5092, 5378, 'Notebook: narrow automation vs general-purpose AI')
    b.keep(5378, 5700, 'Live video: Winning the Race document drawing (replaces the White House photo)', video_from=6078, video_src=DRAWINGS, video_end=6353)
