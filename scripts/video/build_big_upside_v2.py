#!/usr/bin/env python3
"""Big Upside v2 review candidate from big-upside-1 (2026-09-24). Review only.
...
OUT = ROOT / "video-audit/big-upside-v2-2026-09-24/build"
DEST = P / "big-upside-v2.mp4"
...
def main():
    ...
    # CUT 3 2391-2449
    b.keep(2449, 2916, "Possible Shapes: atoms vs shapes, Protein Facts", "protein")
    b.keep(2916, 3075, "BREAK D: LIVE bead chain folding under 'the sequence determines the folding'", video_from=550, video_src=L3, video_end=700)
    b.keep(3075, 3325, "Possible Shapes: Protein Facts, fifty years, about 200,000", "protein")
    ...
    b.manifest({
        "scope_detail": "Full production pass on big-upside-1 (David's 'Build it' 2026-09-24 on the review's best-of plan): five narration cuts, one audio graft from roll 2, canonical boards with five Notebook breaks, three photograph spans and three invented-figure drawings covered, standard close.",
        "narration_changes": {
        ...
        "board_breaks": [
            ...
            {"board": "protein", "source_frames": [2916, 3075], "drawing": "LIVE 550-699 bead chain folding into a tangle"},
