#!/usr/bin/env python3
"""Rise of Agents v3 review candidate (2026-09-24). Review only; the live video and v2 are unchanged.
...
OUT = ROOT / "video-audit/rise-of-agents-v3-2026-09-24/build"
DEST = P / "rise-of-agents-v3.mp4"
...
def main():
    ...
    args = ap.parse_args()
    b = Build(ROOT, SRC, OUT, DEST, protected=[R1, LIVE, GPS, COMPARE, LOOP, ROGUE, CLOSE, LESSON, ROOT / "index.html", P / "rise-of-agents-v2.mp4"])
    ...
    b.manifest({
        "scope_detail": "v2 with David's three notes (2026-09-24): the live video's intro replaces v2's opening; section-level rings wherever the narration speaks a section inside a card; the live video's loop narration replaces roll 2's (two live sentences left out, roll 1's banner line kept).",
        "narration": [
