...
# baseline 3: 2 counter pills + 1 evidence pill in AIIsMath "Tying the math
#   together" box (deliberate, not a counter). The section-overview "NN / N"
#   badge in renderOverview was removed 2026-06-06.
