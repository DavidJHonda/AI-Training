...
filter+=",drawtext=fontfile='$title_font':text='1':fontsize=24:fontcolor=white:x=224-text_w/2:y=190+(60-text_h)/2"
filter+=",drawtext=fontfile='$title_font':text='2':fontsize=24:fontcolor=white:x=512-text_w/2:y=190+(60-text_h)/2"
filter+=",drawtext=fontfile='$title_font':text='3':fontsize=24:fontcolor=white:x=800-text_w/2:y=190+(60-text_h)/2"
filter+=",drawtext=fontfile='$title_font':text='4':fontsize=24:fontcolor=white:x=1088-text_w/2:y=190+(60-text_h)/2"
filter+=",drawtext=fontfile='$title_font':text='5':fontsize=24:fontcolor=white:x=1376-text_w/2:y=190+(60-text_h)/2"
