...
Updated 2026-09-10: paths corrected to `lessons/`, Your Choices temperature board removed.

`Master Prompt.md` is retired and is never uploaded. Each Build Your Skills lesson prompt is self-contained. Upload only the lesson Markdown and the files listed under **Notebook sources**. Files under **Post-production boards** are exact current lesson boards, but they contain visible faces and must not be uploaded to Gemini Notebook; the prompt reserves their narration spans for exact replacement in post.
...
- Notebook sources:
  ...
  3. `lessons/your-choices-4-close.jpg`

The temperature board moved to One More Thing on 2026-09-09 and is no longer part of this lesson; slot 3 is intentionally vacant.
...
- Prompt: `Prompts/people-skills-video-prompt.txt`
...
- Prompt: `Prompts/creative-thinking-video-prompt.txt`
...
- Prompt: `Prompts/make-your-move-video-prompt.txt`
