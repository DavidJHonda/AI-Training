...
const position=children.findIndex(n=>n.props?.src==='course-assets/hallucination/hallucination-4-check-claim.jpg');
...
const page=fs.readFileSync(path.join(root,'course-assets/hallucination/hallucination-4-check-claim.jpg'));
const prep=fs.readFileSync(path.join(root,'course-assets/hallucination/hallucination-4-check-claim.jpg'));
