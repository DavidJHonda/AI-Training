...
OUT=ROOT/'video-audit/transformer-full-2026-09-10/v6'
DEST=ROOT/'Prompts/transformer-v6.mp4'
PREV=OUT.parent/'v5'
FPS=30; SR=48000
...
def main():
    ...
    protected=[ROOT/'course-assets/transformer/transformer.mp4',ROOT/'Prompts/transformer-v5.mp4',ROOT/'Prompts/transformer-v4.mp4',ROOT/'Prompts/transformer-1.mp4',ROOT/'Prompts/transformer-2.mp4',ROOT/'index.html',ROOT/'lessons/transformer.md',ROOT/'course-assets/transformer/transformer-word-order.jpg']
    ...
    keep('v5',0,219.0666666667,'Approved v5 through pause before word order','v5')
    ...
    boundaries=[b for b in previous['boundaries'] if b['frame']<fr(219.0666666667)]
    ...
    readers={'v5':Reader(ROOT/'Prompts/transformer-v5.mp4'),'live':Reader(OUT/'live-cfr.mp4')}
    ...
    m['render_sha256']=sha(DEST);m['protected_files_unchanged']={str(p):sha(p)==hashes[str(p)] for p in protected};assert all(m['protected_files_unchanged'].values())
