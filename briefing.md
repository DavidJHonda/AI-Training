...
- Understand AI (16): one section group with a single opener; the former Inside AI and AI Answers sub-openers were removed and their framing folded into tokens (top) and training (end):
  - Foundations: Opener (openerfoundations), AI Primer (primer), How We Got Here (howwegothere), Rules vs Patterns (aivscode), No One Wrote the Rules (norules), AI's Fuel (data), AI is Math (aiismath)
