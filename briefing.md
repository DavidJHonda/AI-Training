...
- Understand AI (18): one section group with a single opener; the former Inside AI and AI Answers sub-openers were removed and their framing folded into tokens (top) and training (end):
  ...
  - How AI builds an answer: Your Input & the Context Window (prompt), Patterns (patterns), Probability (probability), Inference: From Prompt to Output (inference), What AI Does Best (whatitdoesbest)
