...
SOURCE=ROOT/'Prompts/tokens-4.mp4';DEST=ROOT/'Prompts/tokens-v6.mp4'
...
def main():
 ...
 assets={'chat':ROOT/'course-assets/tokens/tokens-using-ai-feels-like.jpg','blocks':ROOT/'course-assets/tokens/tokens-building-blocks.jpg','send':ROOT/'course-assets/tokens/tokens-how-tokenization-works.jpg','cat':ROOT/'course-assets/tokens/tokens-cat-token-id.jpg','examples':ROOT/'course-assets/tokens/tokens-how-ai-splits-text.jpg','whole':OUT/'assets/whole-and-part.png','math':OUT/'assets/words-to-math.png','close':OUT/'close.png'}
