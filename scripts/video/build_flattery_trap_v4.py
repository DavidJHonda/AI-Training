#!/usr/bin/env python3
"""Build Flattery Trap v4 from flattery-trap-4 (2026-09-21 five-way review: rolls 1-4 and the live video).
...
OUT = ROOT / "video-audit/flattery-trap-comparison-2026-09-21/build-v4"
DEST = ROOT / "Prompts/flattery-trap-v4.mp4"
...
QUOTE = (950, 1027)                # the AI response text at the top of each card
