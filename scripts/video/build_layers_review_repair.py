...
OUT=ROOT/'video-audit/layers-repair-2026-09-10';DEST=ROOT/'videos/layers-v2.mp4'
...
def main():
 ...
 protected=[*src.values(),ROOT/'videos/layers.mp4',ROOT/'index.html',ROOT/'lessons/layers.md']
