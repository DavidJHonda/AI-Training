#!/usr/bin/env python3
"""Remove the Age Rules Matter section from the approved Your Choices video.
...
AUDIT = ROOT / 'video-audit/your-choices-age-rules-cut'
SOURCE = ROOT / 'archive/your-choices/your-choices-before-age-rules-cut-20260925.mp4'
OUTPUT = AUDIT / 'your-choices-without-age-rules.mp4'
FPS = 30
CUT_START, CUT_END, ORIGINAL_FRAMES = 1218, 1766, 5412
...
def main():
    ...
    manifest = {
        ...
        'notes': ['Four-choices intro joins directly to the first-two-choices board.',
                  'Age Rules Matter board and narration (0:40.60-0:58.87) removed at its scene cuts.'],
    }
