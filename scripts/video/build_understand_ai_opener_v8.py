#!/usr/bin/env python3
"""Understand AI opener v8 review candidate from understand-ai-opener-1 (2026-09-22). Review only.
...
OUT = ROOT / "video-audit/understand-ai-opener-comparison-2026-09-22/build-v8"
DEST = ROOT / "Prompts/understand-ai-opener-v8.mp4"
...
def main():
    ...
    b.keep(CARD_OUT, A_OUT, "Notebook car drawings (hood closed, hood open)")
    ...
    b.manifest({
        ...
        "photographs_and_invented_diagrams": [
            {"frames": [1107, A_IN], "what": "AI UNDER THE HOOD mechanism diagram and torn-paper circuit collage", "handling": "inside cut A"},
